...
const SCHEDULE_EVERY = "every 10 minutes";   
const REQUESTS_PER_MIN_CAP = 10;         
const TARGET_BATCH_PER_RUN = 10;           
const MIN_SPACING_MS = 10_000;             
const JITTER_MS = 400;                     
const MIN_REFRESH_MS = 24 * 60 * 60 * 1000; 
const ERROR_COOLDOWN_MS = 20 * 60 * 1000;   
const ERROR_WINDOW_MAX = 8;                
...
exports.updateAllWeaponPrices = onSchedule(SCHEDULE_EVERY, async () => {
  try {
    ...
    const MAX_PER_RUN_BY_CAP = REQUESTS_PER_MIN_CAP * 5; 
